...
int main(void)
{
    ...
    //LED pins Output
    PyHal_GPIO_SetDir(2,0); //QO
    PyHal_GPIO_SetDir(3,0); //Q1
    PyHal_GPIO_SetDir(4,0); //Q2
    PyHal_GPIO_SetDir(5,1); //D0
    PyHal_GPIO_SetDir(6,1); //D1
    PyHal_GPIO_SetDir(7,1); //D2
    PyHal_GPIO_SetDir(8,0); //q1
    PyHal_GPIO_SetDir(9,1); //d1
    PyHal_GPIO_SetDir(10,0); //clk
    PyHal_GPIO_Set(2,0);
    PyHal_GPIO_Set(3,0);
    PyHal_GPIO_Set(4,0);
